...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
    ...
    <select class="form-select" aria-label="Default select example" onchange=getval(this);  id="1"><option> Select Sub Category </option> </select>
    ...
    function getval(sel)
    {
        ...
        let optionId = sel.value;
            $.ajax({
                    ...
                    // remove select element if exist before
                    ...
                    if(data.data[0].children.length > 0){;
                        $("#childdiv").append(` 
                                <select class="form-select" aria-label="Default select example" onchange=getval(this); id=${selectId}> <option> Select Sub Category </option> </select>`);
